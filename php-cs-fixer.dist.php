...
$config->setRules([
    ...
    'binary_operator_spaces' => [
        'operators' => [
            '=>' => 'align_single_space_minimal', // Align double arrow symbols in consecutive lines.
            '=' => 'align_single_space_minimal', // Align equals symbols in consecutive lines.
        ],
    ],
    ...
    'blank_line_before_statement'           => [
        'statements' => ['return'], // An empty line feed should precede a return statement.
    ],
    'concat_space' => [
    ...
    'trailing_comma_in_multiline'           => [
        'elements' => ['arrays'], // PHP multi-line arrays should have a trailing comma.
    ],
    'single_blank_line_before_namespace'    => true, // There should be exactly one blank line before a namespace declaration.
    'class_attributes_separation'           => [
        'elements' => [
            'method' => 'one', // There should be one blank line between each method.
        ],
    ],
]);
